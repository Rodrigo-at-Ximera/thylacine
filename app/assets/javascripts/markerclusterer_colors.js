...
/**
 * @name MarkerClusterer with colors for Google Maps v3
 * @version version 1.0.1.1
 * @author Rodrigo Gonzalez
 * @fileoverview
 * Modified from MarkerClusterer for Google Maps v3, version 1.0.1 by Luke Mahe.<br/>
...
function MarkerClusterer(map, opt_markers, opt_options) {
  ...
  this.styles_ = options['styles'] || [];
     ...
     * @private
     */
    this.bgColor_ = options['color'] ||
      this.MARKER_CLUSTER_BG_COLOR_;
...
/**
 * The defualt color array.
 *
 * @type {Array}
 * @private
 */
MarkerClusterer.prototype.MARKER_CLUSTER_BG_COLOR_ = [255, 0, 0];
...
/**
 * Returns the color for the clusters and markers
 *
 * @return {Array} The color values.
 */
MarkerClusterer.prototype.getBgColor = function() {
...
MarkerClusterer.prototype.show = function(color) {
    this.bgColor_ = color;
...
ClusterIcon.prototype.onAdd = function() {
  ...
  if (this.visible_) {
    ...
    google.maps.event.addDomListener(this.div_,  'mousedown', function(e){
        ...
        moveListener = google.maps.event.addListener(that.map_,  'drag', function(e){
            scroll = true;
        });
    });
...
ClusterIcon.prototype.createCss = function(pos) {
    ...
    const color = this.cluster_.getMarkerClusterer().getBgColor();

    style.push('background-color: rgba('
        + color[0] + ', '
        + color[1] + ', '
        + color[2]
        + ', 0.75);');
